...
/Users/totsu00/.local/bin/uv run python lib/wp_client.py --action check
```
...
```bash
cd /Users/totsu00/ClaudeCodeWork/wp-auto-poster
/Users/totsu00/.local/bin/uv run python lib/wp_client.py --action publish --draft-dir ../drafts/{slug}/
```
